        ...
        switch (section.type) {
          case "heading":
            return (
              <h3
                key={idx}
                className="text-sm font-bold text-[#1E2136]"
              >
                {section.text}
              </h3>
            );
  ...
  return (
    <div className="shrink-0 lg:w-80 lg:sticky lg:top-6">
      <div className="rounded-2xl border border-[#D9E2EC] bg-white p-6 shadow-[0_20px_40px_-32px_rgba(27,54,93,.35)]">
        ...
        <h2
          className={`text-[22px] font-extrabold tracking-[-.01em] text-[#1E2136] ${isPaid ? "mt-1" : ""}`}
        >
          {type.name}
        </h2>
        ...
        <div className="mt-3 space-y-2 text-sm text-stone-700">
          <div className="flex items-center gap-2.5">
            <Clock className="h-4 w-4 text-[#62D4A6]" />
            <span className="font-medium">{type.duration_minutes} minutes</span>
          </div>
          <div className="flex items-center gap-2.5">
            {type.default_location_type === "online" ? (
              <Video className="h-4 w-4 text-[#62D4A6]" />
            ) : (
              <MapPin className="h-4 w-4 text-[#62D4A6]" />
            )}
          ...
          <div className="flex items-center gap-2.5">
            <DollarSign className="h-4 w-4 text-[#62D4A6]" />
            <span className="font-medium">
        ...
        {slot && clientTimezone && (
          <div className="mt-4 border-t border-[#EDF1F7] pt-4">
            ...
            <p className="mt-1 text-[15px] font-bold text-[#1E2136]">

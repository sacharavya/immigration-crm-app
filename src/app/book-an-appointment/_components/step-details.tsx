    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-5 lg:flex-row lg:items-start">
        ...
        <div className="min-w-0 flex-1">
          ...
          >
            <h2 className="text-xl font-extrabold tracking-[-.01em] text-[#0D4231]">
              Enter your details
            </h2>
            ...
            <div className="mt-4 space-y-4">
              <FormField label="Full name" required>
                <input
                  ...
                  autoComplete="name"
                  disabled={submitting}
                  className="h-10 w-full rounded-lg border border-[#D9E2EC] bg-white px-3 text-sm outline-none focus:border-[#0D4231] focus:ring-2 focus:ring-[#0D4231]/20"
                />
              </FormField>
              ...
              <FormField label="What would you like to discuss?" required>
                <textarea
                  ...
                  className="w-full rounded-lg border border-[#D9E2EC] bg-white px-3 py-2 text-sm outline-none focus:border-[#0D4231] focus:ring-2 focus:ring-[#0D4231]/20"
                />
              </FormField>
            ...
            <div className="mt-5 flex justify-end">
              <button
                type="submit"
                disabled={submitting}
                className="inline-flex h-11 items-center gap-2 rounded-[10px] bg-[#0D4231] px-6 text-sm font-semibold text-white shadow-[0_12px_30px_-14px_rgba(61,111,216,.7)] transition-colors hover:bg-[#14523D] disabled:opacity-60"
              >
                {submitting ? (
                  <>

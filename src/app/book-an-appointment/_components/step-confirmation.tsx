    ...
    <div className="flex flex-col gap-5 lg:flex-row lg:items-start">
      ...
      <div className="min-w-0 flex-1">
        {result.consultation_sign_url && (
          <div className="mb-4 border border-[#0F5132]/30 bg-[#0F5132]/5 p-4">
            ...
            <a
              ...
              className="mt-2 inline-flex h-9 items-center bg-[#0F5132] px-4 text-sm font-medium text-white hover:bg-[var(--navy-light)]"
            >
              Sign now
            </a>
          </div>
  ...
  if (error === "slot_taken") {
    ...
    action = (
      <button
        ...
        className="inline-flex items-center bg-[#0F5132] px-3 py-1.5 text-sm font-medium text-white hover:bg-[var(--navy-light)]"
      >
        Back to slot picker
      </button>
    );

  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-4 rounded-2xl border border-[#D9E2EC] bg-white px-6 py-20 text-center shadow-[0_20px_40px_-32px_rgba(27,54,93,.35)]">
        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#EEF4F0] text-[#0F5132]">
        ...
        <Link
          ...
          className="mt-2 rounded-[10px] bg-[#0F5132] px-5 py-3 text-sm font-semibold text-white shadow-[0_12px_30px_-14px_rgba(61,111,216,.7)] transition-colors hover:bg-[#146540]"
        >
          Book a consultation
        </Link>
      </div>

...
//
// Intentionally vague — we don't reveal which of those is true to a
// random visitor. Just points them at the firm's contact.

export function ExpiredCard() {
  return (
    <main className="flex min-h-dvh items-center justify-center bg-stone-50 px-6 py-12">
      <div className="w-full max-w-lg rounded-2xl border border-stone-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-3 text-center text-sm text-stone-600">
          Either the link has been rotated, the case has moved past the
          document review stage, or the case has been closed.
        </p>
        <p className="mt-6 text-center text-sm text-stone-700">
          Please contact our office for help:
        </p>
        <p className="mt-1 text-center text-sm font-medium text-stone-900">

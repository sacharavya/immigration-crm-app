    ...
    <footer className="mt-auto px-6 pb-8 pt-24">
      <div className="mx-auto grid max-w-[1120px] gap-10 border-b border-[#D9E2EC] pb-10 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr]">
        ...
        <div className="flex flex-col gap-2.5 text-[13px]">
          <div className="font-bold text-[#1E2136]">Explore</div>
          <Link href="/#services" className="text-[#5A6A85] hover:text-[#1E2136]">
            Services
          </Link>
          <Link href="/book-an-appointment" className="text-[#5A6A85] hover:text-[#1E2136]">
            Book an appointment
          </Link>
          <Link href="/crs-calculator" className="text-[#5A6A85] hover:text-[#1E2136]">
            CRS Calculator
          </Link>
          <Link href="/find-your-noc-code" className="text-[#5A6A85] hover:text-[#1E2136]">
            Find your NOC Code
          </Link>
        </div>
        <div className="flex flex-col gap-2.5 text-[13px]">
          <div className="font-bold text-[#1E2136]">Firm</div>
          <Link href="/about-us" className="text-[#5A6A85] hover:text-[#1E2136]">
            About us
          </Link>
          <Link href="/immigration-crm-software" className="text-[#5A6A85] hover:text-[#1E2136]">
            BBI-CRM for firms
          </Link>
          <Link href="/login" className="text-[#5A6A85] hover:text-[#1E2136]">
            Staff login
          </Link>
        </div>
        <div className="flex flex-col gap-2.5 text-[13px]">
          <div className="font-bold text-[#1E2136]">Legal</div>
          <Link href="/privacy-policy" className="text-[#5A6A85] hover:text-[#1E2136]">
            Privacy Policy
          </Link>
          <Link href="/data-usage" className="text-[#5A6A85] hover:text-[#1E2136]">
            Data Usage
          </Link>
          <Link href="/terms" className="text-[#5A6A85] hover:text-[#1E2136]">
            Terms of Use
          </Link>
        </div>
      </div>

...
export function retainerSignedConfirmationEmail(args: Args): {
  ...
  const subject = `Your retainer is signed — genzdatalabs Immigration`;
  ...
  const attachmentLine = args.hasAttachment
    ...
    : `<p style="margin:0 0 12px 0;">Your signed agreement is on file with our office. Email us at info@genzdatalabs.com if you'd like a copy sent to you.</p>`;
...
<p style="margin:24px 0 0 0;">If you have any questions, email us at info@genzdatalabs.com.</p>`;
...
If you have any questions, email us at info@genzdatalabs.com.

...
export function retainerSignedConfirmationEmail(args: Args): {
  ...
  const attachmentLine = args.hasAttachment
    ...
    : `<p style="margin:0 0 12px 0;">Your signed agreement is on file with our office. Reply to this email if you'd like a copy sent to you.</p>`;
...
<p style="margin:24px 0 0 0;">If you have any questions, reply to this email.</p>`;

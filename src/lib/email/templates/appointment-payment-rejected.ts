...
<p style="margin:0 0 12px 0;">We&apos;ve cancelled this booking and released the slot. To book again, use the button below. If you believe this was a mistake or need help, reply to this email.</p>
${buttonHtml("Book a new consultation", args.bookAgainUrl)}`;
  ...
  const text = [
    ...
    "",
    `We've cancelled this booking and released the slot. To book again, visit ${args.bookAgainUrl}. Reply to this email if you need help.`,
  ].join("\n");

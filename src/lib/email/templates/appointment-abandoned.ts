...
<p style="margin:0 0 12px 0;">If you&apos;d still like to book a consultation, use the button below. Reply to this email if you need help.</p>
${buttonHtml("Book a new consultation", args.bookAgainUrl)}`;
  ...
  const text = [
    ...
    "",
    `If you'd still like to book a consultation, visit ${args.bookAgainUrl}. Reply to this email if you need help.`,
  ].join("\n");

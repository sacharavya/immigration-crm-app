...
<p style="margin:0 0 12px 0;">If you&apos;d still like to book a consultation, use the button below. Email us at info@bigbangimmigration.com if you need help.</p>
${buttonHtml("Book a new consultation", args.bookAgainUrl)}`;
  ...
  const text = [
    ...
    "",
    `If you'd still like to book a consultation, visit ${args.bookAgainUrl}. Email us at info@bigbangimmigration.com if you need help.`,
  ].join("\n");

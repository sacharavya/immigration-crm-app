...
// Read public/casebind-logo.png once at module load and encode it as a data URL so
...
//     base URL to resolve a /casebind-logo.png reference)
//
...
export function getLetterheadLogoDataUrl(): string {
  ...
  const path = join(process.cwd(), "public", "casebind-logo.png");
